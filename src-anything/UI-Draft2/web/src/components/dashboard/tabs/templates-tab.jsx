...
export default function TemplatesTab({ onAfterApply }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <SectionHeader
          title="Save current layout as canvas"
          subtitle="Snapshot all widget positions and configs with canvas dimensions. Switch layouts in one click."
        />
        <Card className="p-5">
